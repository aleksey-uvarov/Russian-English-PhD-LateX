...
\include{Dissertation/intro_and_basics}    % Введение
\ifnumequal{\value{contnumfig}}{1}{\counterwithout{figure}{chapter}
}{\counterwithin{figure}{chapter}}
\ifnumequal{\value{contnumtab}}{1}{\counterwithout{table}{chapter}
}{\counterwithin{table}{chapter}}
\include{Dissertation/vqas_review}
\include{Dissertation/numerical_experiments}
\include{Dissertation/qml}
\include{Dissertation/plateaus}
\include{Dissertation/telescope}
% \include{Dissertation/part1}           % Глава 1
% \include{Dissertation/part2}           % Глава 2
% \include{Dissertation/part3}           % Глава 3
\include{Dissertation/conclusions}      % Заключение
